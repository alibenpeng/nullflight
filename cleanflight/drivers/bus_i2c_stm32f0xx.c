...
void i2cInitPort(I2C_TypeDef *I2Cx)
{
    ...
    if (I2Cx == I2C1) {
        ...
        GPIO_PinAFConfig(I2C1_SCL_GPIO, I2C1_SCL_PIN_SOURCE, GPIO_AF_1);
        GPIO_PinAFConfig(I2C1_SDA_GPIO, I2C1_SDA_PIN_SOURCE, GPIO_AF_1);
        ...
        // In calculator: 10 Khz, 8Mhz Clock, Analog Filter Delay ON, Rise 100, Fall 10.
        // In reality: ???kHz
        //I2C_InitStructure.I2C_Timing = 0x101098F3;

        I2C_InitStructure.I2C_Timing = 0x00901850; // 400 Khz, 48Mhz Clock, Analog Filter Delay ON, Rise 100, Fall 10.
        //I2C_InitStructure.I2C_Timing = 0x10805E89; // 100 Khz, 48Mhz Clock, Analog Filter Delay ON, Rise 100, Fall 10.
        //I2C_InitStructure.I2C_Timing = 0x00201D2B; // 100 Khz, 8Mhz Clock, Analog Filter Delay ON, Rise 100, Fall 10.
        //I2C_InitStructure.I2C_Timing = 0x0010020A; // Fast mode, 400 Khz, 8Mhz Clock, Analog Filter Delay ON, Rise 100, Fall 10.
